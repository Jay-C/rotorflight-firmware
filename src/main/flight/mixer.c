...
static void mixerUpdateInputs(void)
{
    ...
    mixInput[MIXER_IN_STABILIZED_THROTTLE] = mixerScaleInput(MIXER_IN_STABILIZED_THROTTLE, getGovernorOutput());
}
...
{
    return fabs(mixInput[MIXER_IN_STABILIZED_COLLECTIVE]);
}
