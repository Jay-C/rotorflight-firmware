...
typedef struct pidProfile_s
{
    ...
    uint16_t  dynamic_ff_gain[XYZ_AXIS_COUNT];    // Dynamic feedforward
    uint8_t   dynamic_ff_cutoff[XYZ_AXIS_COUNT];  // Dyn FF Cutoff freq
    ...
    uint8_t   pitch_bounce_filter_level;      // Pitch/Elevator bounce filter setpoint level
    uint8_t   pitch_bounce_filter_delay;      // Pitch/Elevator bounce filter time delay
